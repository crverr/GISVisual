<template>
  <div class="visual_box">
    ...
    <TopRightContent v-if="item[1] == 4" />
    <BottomRightContent v-if="item[1] == 6"  />
...
import TopRightContent from '@/components/TopRightContent'
import BottomRightContent from '@/components/BottomRightContent'
export default {
  name: "",
  components: {TopRightContent,BottomRightContent},
  props: ["item"],
  data() {
    return {
    };
